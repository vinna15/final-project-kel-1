<x-layouts.app title="Barang Keluar">
<div class="max-w-lg">
    <x-card title="Form Barang Keluar">
        <form method="POST" action="{{ route('stocks.out.store') }}" class="space-y-4">
            @csrf
            ...
            <x-input
                ...
                placeholder="Misal: Retur, Rusak, dll"
            />

            <div class="flex gap-3 pt-2">
                <x-button type="submit" variant="danger">Simpan Barang Keluar</x-button>
